...
%S3BATCH%  -mdeffn ./model/hmm/hub4_cd_continuous_8gau_1s_c_d_dd/mdef -fdictfn ./model/lm/an4/filler.dict -dictfn ./model/lm/an4/an4.dict -lmfn ./model/lm/an4/an4.ug.lm.DMP -langwt 13.0 -inspen 0.2 -ctlfn ./model/lm/an4/an4.ctl.platform_independent -inlatdir ./model/lm/an4/ -logbase 1.0003 -backtrace 1 
