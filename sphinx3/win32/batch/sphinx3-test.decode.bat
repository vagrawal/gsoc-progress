...
%S3BATCH% -mdef ./model/hmm/hub4_cd_continuous_8gau_1s_c_d_dd/mdef -fdict ./model/lm/an4/filler.dict -dict ./model/lm/an4/an4.dict -mean ./model/hmm/hub4_cd_continuous_8gau_1s_c_d_dd/means -var ./model/hmm/hub4_cd_continuous_8gau_1s_c_d_dd/variances -mixw ./model/hmm/hub4_cd_continuous_8gau_1s_c_d_dd/mixture_weights -tmat ./model/hmm/hub4_cd_continuous_8gau_1s_c_d_dd/transition_matrices -lm ./model/lm/an4/an4.ug.lm.DMP -ctl ./model/lm/an4/an4.ctl -cepdir ./model/lm/an4/ -agc none -varnorm no -cmn current -subvqbeam 1e-02 -epl 4 -fillprob 0.02 -feat 1s_c_d_dd -lw 9.5 -maxwpf 1 -beam 1e-40 -pbeam 1e-30 -wbeam 1e-20 -maxhmmpf 1500 -wend_beam 1e-1 -ci_pbeam 1e-3 -ds 2  
