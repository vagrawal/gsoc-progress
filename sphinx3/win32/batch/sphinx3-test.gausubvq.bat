...
%S3BATCH%  -mean ./model/hmm/hub4_cd_continuous_8gau_1s_c_d_dd/means -var  ./model/hmm/hub4_cd_continuous_8gau_1s_c_d_dd/variances -mixw  ./model/hmm/hub4_cd_continuous_8gau_1s_c_d_dd/mixture_weights -svspec 0-38 -iter 20 -svqrows 16 -seed 1111 -subvq subvq.out 
